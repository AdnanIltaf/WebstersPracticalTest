...
{
    public class IssueFinesController : Controller
    {
        ...
        // GET: IssueFines/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: IssueFines/Create
